...
#        set prompt \033[38;5;197mgdb$ \033[0m
        set prompt \033[38;5;29mgdb$ \033[0m
end
...
set $TUI_MODE_ENABLED = 0

define tui_mode_toggle
  if $TUI_MODE_ENABLED == 1
    set $TUI_MODE_ENABLED = 0
    no_tui_mode
  else
    set $TUI_MODE_ENABLED = 1
    tui_mode
  end
end

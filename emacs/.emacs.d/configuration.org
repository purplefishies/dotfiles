...
(setq org-html-head
"<style>
/* ---- CODE BLOCK CONTAINER (makes width consistent & centered) ---- */
div.org-src-container {
  max-width: 800px;        /* ✅ set your desired code block width */
  margin-left: auto;
  margin-right: auto;
}
...
pre.src {
  ...
  font-size: 0.9rem;
  line-height: 1.45;
  white-space: pre;         /* ✅ prevents weird wrapping / shifting */
}
...
<script>
// Add ChatGPT-style \"Copy code\" buttons
document.addEventListener('DOMContentLoaded', function () {
  document.querySelectorAll('pre.src').forEach(function(pre) {
    ...
    btn.addEventListener('click', () => {
      ...
      const buttonInClone = clone.querySelector('.copy-code-btn');

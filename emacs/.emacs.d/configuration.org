...
** Org Drill
   :PROPERTIES:
   :ID:       f6ba9994-c4e7-4936-b96b-609e0c22e38f
   :END:
#+BEGIN_SRC emacs-lisp
; (eval-after-load "org"
;   '(progn
...
(setq org-capture-templates
      '(("t" "Todo" entry (file+headline "~/Projects/org/inbox.org" "Tasks")
         "* TODO %?\n%i\n   %a")
        ("j" "Journal" plain (file+function jd/journal-date-path jd/find-create-date-entry )
         "** %?\n" )
        ("W" "Work Journal" plain (file+function jd/journal-date-path jd/find-create-date-entry )
         "** \t\t:work:\n" )
        ;; ("j" "Journal" entry (file+olp+datetree "~/Projects/org/journal.org")
        ;;  "* %? %^G\n")
        ;; ("K" "Journal Test" plain (file+function jd/journal-date-path jd/find-create-date-entry )
        ;;  "** %?\n" )
        ;; ("W" "Work Journal" entry (file+olp+datetree "~/Projects/org/journal.org")
        ;;  "* %?\t\t:work:\n")
        ;; ADD THESE IN LATER... you don't have the bandwidth for 
        ;; ALl of these sub types
        ;; ("Q" "Questions" entry (file+olp+datetree "~/Projects/org/questions.org")
        ;;  "* %?\t\t:questions:\n   :PROPERTIES:\n    :CREATED:%T\n    :END:\n\n")
        ;; ("f" "Finished book"
        ;;  table-line (file "~/Documents/notes/books-read.org")
        ;;  "| %^{Title} | %^{Author} | %u |")
        ;; ("c" "Cookbook" entry (file "~/Projects/org/cookbook.org" )
...
(setq org-agenda-custom-commands
      '(("c" "Simple agenda view"
        ...
        ;; ("1" "Q1" tags-todo "+important+urgent") ; Not needed right now 
        ;; ("2" "Q2" tags-todo "+important-urgent") ; revisit someday
...
:END:
#+begin_src emacs-lisp
    (setq reftex-default-bibliography '("~/Projects/org/Zettelkasten/ref.bib"))

    (setq org-ref-bibliography-notes "~/Projects/org/ref_notes.org"
          org-ref-default-bibliography '("~/Projects/org/Zettelkasten/ref.bib")
          org-ref-pdf-directory "~/bibtex-pdfs/")

    (setq bibtex-completion-bibliography "~/Projects/org/Zettelkasten/ref.bib"
          bibtex-completion-library-path "~/Projects/org/bibtex-pdfs"
          bibtex-completion-notes-path "~/Projects/org/bibtex-notes")
...
:END:
#+begin_src emacs-lisp
(setq org-roam-dailies-directory "/home/jdamon/Projects/org/Roam/daily")

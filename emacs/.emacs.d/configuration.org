...
(defun my-org-insert-image ()
  "Prompt for an image, copy it to <basename>/<YEAR>/<Mon>/, insert link, display inline."
  (interactive)
  ...
  (let* ((src (read-file-name "Select image file: "))
         (base (file-name-base (buffer-file-name)))   ;; e.g., inbox
         ...
         ;; relative path used in org link
    ...
    (message "Image copied to: %s" dest-file)))
